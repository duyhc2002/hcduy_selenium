...
class RecruitmentPage(BasePage):
    def __init__(self, driver):
        ...
        self.job_title_option = (By.XPATH,"//span[normalize-space()='Account Assistant']")
        ...
        self.hiring_manager_option = (By.XPATH, "//div[@role='option']//span[contains(text(),'Rahul')]")
    ...
    def add_vacancy(self):
        ...
        self.driver.find_element(*self.hiring_manager_field).send_keys('Rahul Patil')
